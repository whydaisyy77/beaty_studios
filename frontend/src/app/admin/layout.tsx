...
const navItems = [
  ...
  { href: '/admin/dashboard/services', label: 'Услуги', icon: Scissors },
  { href: '/admin/dashboard/gallery', label: 'Портфолио', icon: Image },
  { href: '/admin/dashboard/masters', label: 'Мастера', icon: Users },
];
      ...
      <div className="flex-1 lg:ml-64 flex flex-col min-h-screen">
        <header className="bg-white border-b border-gray-200 px-4 sm:px-6 py-4 flex items-center gap-4">
          ...
          <h1 className="text-sm font-medium text-gray-500">
            {navItems.find((n) => n.href === pathname)?.label || 'Панель управления'}
          </h1>
